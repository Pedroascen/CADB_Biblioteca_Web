...
import udb.cdba.model.CdModel;

/**
 *
 * @author Jazmine
 */
@WebServlet(name = "CdController", urlPatterns = {"/cd"})
public class CdController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (accion) {
                ...
                case "nuevo":
                    request.getRequestDispatcher("/cd/add.jsp").forward(request, response);
                    break;
                case "insertar":
    ...
    private void insertar(HttpServletRequest request, HttpServletResponse response) {
        ...
        String cejemp = request.getParameter("cejemp");
        String autor = request.getParameter("autor");
        String paispubli = request.getParameter("paispubli");
        String anio_publi = request.getParameter("anio_publi");
        String ciudadpub = request.getParameter("ciudadpub");
        String volumen = request.getParameter("volumen");
        String idioma = request.getParameter("idioma");
        String tema = request.getParameter("tema");

        try {
            if (titulo != "" && ufisica != "" && autor != "" && paispubli != "" && anio_publi != "" && idioma != "" && volumen != "" && tema != "") {
                CdModel cm = new CdModel();
                if (cm.insert_update(codMaterial, titulo, ufisica, cejemp, autor, paispubli, ciudadpub, anio_publi, volumen, idioma, tema)) {
