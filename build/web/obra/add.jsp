...
<html>
    <head>
        ...
        <title>Guardar Obra</title>
    </head>
    <body>
        <jsp:include page="/components/menu.jsp"/>
        <div class="container">
            <form role="form" action="/CADB_Biblioteca_Web/obra?accion=insertar" method="POST">
                <input type="hidden" name="codMaterial">
                <h4 class="mt-4">Agregar nueva Obra</h4>
                <div class="col-md-10">
                    ...
                    <    <label for="contrasenia">Ingrese Género:</label>
                        <div class="input-group">
