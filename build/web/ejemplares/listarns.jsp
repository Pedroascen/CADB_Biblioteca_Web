            ...
            <c:forEach var="ejemplares" items="${ejemplares}">
                <div class="card mt-2 mb-2">
                    <div class="card-body">
                        ...
                        <h6 class="card-title">Codigo: ${ejemplares.codigoMaterial}</h6>
                        <a href="/CADB_Biblioteca_Web/ejemplares/ver_info_ns.jsp" class="card-link">Ver Info</a>
                    </div>
                </div>
            </c:forEach>
            <a href="javascript:history.back()">Regresar</a>
